...
// The transport moved to `@/components/capture/upload-transport` when
// `ConditionForm` was lifted into `src/components`; it is re-exported here so
// every existing import of it from this step keeps working.
export {
  parseProblem,
  parseUploadedPhoto,
  xhrUploadTransport,
